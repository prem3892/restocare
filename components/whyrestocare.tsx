...
export const WhyRestoCare = () => {
  return (
    <section
      className="flex min-h-screen sm:flex-row flex-col gap-[clamp(70px,2vw,24px)] p-[clamp(12px,3vw,40px)] 
    bg-white
    "
    >
      <div className="why-resto-left flex-1 flex justify-center items-center">
  ...
  "
      ...
      <div
        className="why-resto-right flex flex-1 flex-col gap-[clamp(8px,1vw,24px)]
      justify-center
      "
      >
        <Typography
