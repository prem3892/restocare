...
export const WhyRestoCare = () => {
  return (
    <section
      className="flex min-h-screen sm:flex-row flex-col
      justify-center items-center
    bg-white
    "
    >
      <div className="why-resto-left flex-1 flex justify-start items-center max-w-3/7">
  ...
  "
      ...
      <div className="why-resto-right max-w-3/7 flex flex-1 flex-col gap-[clamp(8px,1vw,24px)] justify-center items-center">
        <Typography
